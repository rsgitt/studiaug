//Wykorzystując rozwiązania zadań 8-13 napisz program, który wczyta od użytkownika dwie daty, sprawdzi ich poprawność i dla poprawnych dat zwróci, ile dni różni te daty.
#include<stdio.h>
#include<stdio.h>
...
int dateValid(int year, int month, int day)
{
    if (month < 1 || month > 12)
    {
        return 0;
...
int main()
{
    ...
    if (dateValid(year1, month1, day1) && dateValid(year2, month2, day2))
    {
    ...
    {
        printf("Data lub daty wprowadzone do programu nie sa prawdziwe\n");
    }
}